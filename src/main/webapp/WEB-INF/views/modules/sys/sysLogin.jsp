	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#loginForm").validate({
				...
				messages: {
					username: {required: "Please input login name."},password: {required: "Pease input pasword  ."},
					validateCode: {remote: "Bad erify code  .", required: "Please input verify code."}
				},
...
<body>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
		...
		<c:if test="${isValidateCodeLogin}"><div class="validateCode">
			<label class="input-label mid" for="validateCode">Verify Code</label>
