...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cst/consultant/audit">Consultant List</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="consultant" action="${ctx}/cst/consultant/audit" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="consultant">
			<tr>
				...
				<td>
					<a href="#" onclick="return windowOpen('${ctx}/cst/consultant/profile?submitter=${consultant.submitter}','xxx', 560,600)">View</a>
				</td>
				<td>
					${fns:getUserById(consultant.submitter).name}
				</td>
				<shiro:hasPermission name="cst:consultant:edit"><td>
					<a href="${ctx}/cst/consultant/saveAudit?id=${consultant.id}&formStatus=1" onclick="return confirmx('Confirm to APPROVE Consultant？', this.href)">Approve</a>
					|
					<a href="${ctx}/cst/consultant/saveAudit?id=${consultant.id}&formStatus=-1" onclick="return confirmx('Confirm to DENY Consultant？', this.href)"><font color="red">Deny</font></a>
