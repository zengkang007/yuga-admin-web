 ...
 */
package com.yuga.modules.act.service.ext;
...
import com.yuga.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.yuga.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.yuga.modules.sys.entity.User(null, userId)))){
