 ...
 */
package com.yuga.common.persistence;
...
public class Page<T> {
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页
			sb.append("<li class=\"disabled\"><a href=\"javascript:\">&#171; Previous</a></li>\n");
		} else {
			sb.append("<li><a href=\"javascript:\" onclick=\""+funcName+"("+prev+","+pageSize+",'"+funcParam+"');\">&#171; Previous</a></li>\n");
		}
		...
		sb.append(funcName+"("+pageNo+",this.value,'"+funcParam+"');\" onclick=\"this.select();\"/> records，");
		sb.append("Total " + count + " records"+(message!=null?message:"")+"</a></li>\n");
